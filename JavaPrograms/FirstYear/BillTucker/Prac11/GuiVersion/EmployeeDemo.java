...
public class EmployeeDemo implements ActionListener
{
	...
	*/
	public static void main (String[] args)
	{
		...
		printEmployees = new JButton("Sort Employee");
	...
	{	
		...
		else if (event.getActionCommand().equals("Sort Employees"))
		{
			if(employee_counter == 0)
			{
				textArea.append("Please enter atleast one employee before trying to sort.");
			}
			Arrays.sort(employees, 0, employee_counter);
			getAverageSalary();
			displayEmployees();
